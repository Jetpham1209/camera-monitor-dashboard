...
export TRITON_HTTP_PORT="$(read_env TRITON_HTTP_PORT "8000")"
export TRITON_GRPC_PORT="$(read_env TRITON_GRPC_PORT "8001")"
export TRITON_METRICS_PORT="$(read_env TRITON_METRICS_PORT "8002")"
